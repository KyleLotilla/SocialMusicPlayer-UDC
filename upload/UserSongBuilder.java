...
public class UserSongBuilder implements SongBuilder {
	...
	public int buildSong(Map mapSongProperties) {
		...
		int nSongID = 0;
		try {
			PreparedStatement preparedSongQuery = MyConnection.getConnection().prepareStatement(sSongQuery,Statement.RETURN_GENERATED_KEYS);
			preparedSongQuery.setInt(1, (int) mapSongProperties.get("nUploaderID"));
